...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2022 at 06:16 PM
...
('Najib', 'iam.najib@gmail.com', '$2y$10$KBbFldDVHvboML/zQBgJmuWRK5rlBJhcBRhetY//6XBRw2hnThGXW', 0, '2021-12-26 22:52:39');
...
(5, 'Najib', 'iam.najib@yahoo.com', '$2y$10$UUUQtS1jzBxe37Wj9jKaPepImg9g157AvYWAsmUjLwmoaaNrt3V76', '2021-12-26');
...
(14, 'Prothom Alo ', 370, ' Sunil Gangopaddhay', 'Novel_1.jpg', '2021-12-27 00:13:41', 'Yes');
...
--
-- Dumping data for table `transcationbook`
--

INSERT INTO `transcationbook` (`OrderID`, `Cid`, `name`, `Address`, `contactDetail`, `price`, `PaymentInfo`, `txnStatus`, `exceptDate`, `OrderStatus`, `DeliveryDate`) VALUES
('ORDS42488133', 5, 'NAZMUL HASSAN', ' <br>B <br>10<br>D C<br> ZipCode:100001 CC ', '<br>Mobile No: 0123456789<br>Email: ', 320, NULL, NULL, NULL, NULL, NULL);
